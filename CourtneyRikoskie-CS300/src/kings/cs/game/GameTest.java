...
public class GameTest {
	...
	public void testMoveEastFromStart() {
		...
		assertSame(
				"The player should not move if trying to go east from the front porch (starting position).",
	...
	public void testMoveWestFromStart() {
		...
		assertSame(
				"The player should not move if trying to go west from the front porch (starting position).",
				player.getCurrentRoom(), world.getRoom("Front Porch"));
	}
	...
	public void testMoveDownFromStartUnclearedCondition() {
		...
		assertFalse("The player should lose the game if certain conditions are not met before moving down from starting position.", loss);
	}
	...
	public void testMoveDownFromStartClearedCondition() {
		...
		assertTrue("The game should continue certain conditions are met before moving down from starting position.", loss);
	}
}